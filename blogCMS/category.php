...
<!-- Title of post links to a new page where you are able to read the whole post & with comment functionality -->		
			<div class = "blog-post">
				<h1 class = "blog-post-title"><a href="single.php?post=<?php echo $row['id'] ?>"><?php echo $rows['title']; ?></a></h1>
				<p class = "blog-post-meta"><?php echo $rows['date']; ?>, by <a href="#"><?php echo $rows['author']; ?></a></a></p>
				<p class="mb-0">

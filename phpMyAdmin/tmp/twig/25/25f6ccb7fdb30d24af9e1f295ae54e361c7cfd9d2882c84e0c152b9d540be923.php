...
class __TwigTemplate_ca191d127b46ea6f3bfaed0e0ca87bd25e26fbfced70475ee8e2a0cc2db12764 extends Twig_Template
{
...
$context["one_key"], "ref_db_name", array(), "array")) : (($context["db"] ?? null)));
                    // line 43
                    echo "                        ";
...
$context["one_key"], "ref_table_name", array(), "array")) : (false));
                    ...
                    if ((($context["foreign_db"] ?? null) && ($context["foreign_table"] ?? null))) {
                        ...
                        // line 52
                        echo "                            ";
                        $context["unique_columns"] = $this->getAttribute(($context["table_obj"] ?? null), "getUniqueColumns", array(0 => false, 1 => false), "method");
                        // line 53
                        echo "                        ";
                    }
                    // line 54
...
($context["i"] ?? null), "one_key" => array(), "column_array" =>             // line 74
...
($context["unique_columns"] ?? null)));
    ...
    ";
        // line 97
        if ($this->getAttribute(($context["cfg_relation"] ?? null), "relwork", array(), "array")) {
            // line 98
            echo "        ";
            if (PhpMyAdmin\Util::isForeignKeySupported(($context["tbl_storage_engine"] ?? null))) {
                // line 99
        ...
        <fieldset>
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["i"]) {
                // line 117
                echo "                        ";
                $context["myfield"] = $this->getAttribute($this->getAttribute(($context["save_row"] ?? null), $context["i"], array(), "array"), "Field", array(), "array");
                // line 118
                echo "                        ";
                // line 120
                echo "                        ";
                ...
                // line 126
                echo "                        ";
                if ($this->getAttribute(($context["existrel"] ?? null), ($context["myfield"] ?? null), array(), "array", true, true)) {
                    // line 127
                    echo "                            ";
                    $context["foreign_db"] = $this->getAttribute($this->getAttribute(($context["existrel"] ?? null), ($context["myfield"] ?? null), array(), "array"), "foreign_db", array(), "array");
                    // line 128
                    echo "                        ";
                } else {
                    // line 129
                ...
                if (($context["foreign_db"] ?? null)) {
                    ...
                    if ($this->getAttribute(($context["existrel"] ?? null), ($context["myfield"] ?? null), array(), "array", true, true)) {
                        // line 136
                        echo "                                ";
                        $context["foreign_table"] = $this->getAttribute($this->getAttribute(($context["existrel"] ?? null), ($context["myfield"] ?? null), array(), "array"), "foreign_table", array(), "array");
                        // line 137
                        echo "                            ";
                    }
                    // line 138
                    echo "                            ";
                    $context["tables"] = $this->getAttribute(($context["dbi"] ?? null), "getTables", array(0 => ($context["foreign_db"] ?? null)), "method");
                    // line 139
                    echo "                        ";
                }
                // line 140
                ...
                if ((($context["foreign_db"] ?? null) && ($context["foreign_table"] ?? null))) {
                    ...
                    if ($this->getAttribute(($context["existrel"] ?? null), ($context["myfield"] ?? null), array(), "array", true, true)) {
                        // line 145
                        echo "                                ";
                        $context["foreign_column"] = $this->getAttribute($this->getAttribute(($context["existrel"] ?? null), ($context["myfield"] ?? null), array(), "array"), "foreign_field", array(), "array");
                        // line 146
                        echo "                            ";
                    }
                    // line 147
...
($context["foreign_column"] ?? null)));
    ...
    ";
        // line 169
        if ($this->getAttribute(($context["cfg_relation"] ?? null), "displaywork", array(), "array")) {
            // line 170
            echo "        ";
            $context["disp"] = call_user_func_array($this->env->getFunction('Relation_getDisplayField')->getCallable(), array(($context["db"] ?? null), ($context["table"] ?? null)));
            // line 171
            echo "        <fieldset>
            <label>";
            // line 172
            ...
            foreach ($context['_seq'] as $context["_key"] => $context["row"]) {
                ...
                echo "\"";
                // line 177
                if ((array_key_exists("disp", $context) && ($this->getAttribute($context["row"], "Field", array(), "array") == ($context["disp"] ?? null)))) {
                    // line 178
